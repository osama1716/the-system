...
const CLIENT_JS = ["i18n.js", "constants.js", "storage.js", "engine.js", "cloud.js", "sound.js", "push.js", "ui.js", "main.js"]
  .map((f) => "js/" + f);
...
for (const f of ALL_JS.concat(["functions/index.js", "functions/reminders.js", "functions/presets.js",
  ...
  "functions/reflection.js", "functions/reflection-prompt.js", "functions/suspicion.js"])) {
  const seen = new Map();
