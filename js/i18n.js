...
(function (SYS) {
  ...
  const STRINGS = {
    ...
    "sync.storedWontHold": { en: "Your account accepted the save but did not keep it. Something else is writing over it.", ar: "حسابك قبل الحفظ لكنه لم يحتفظ به. هناك شيء آخر يكتب فوقه.", es: "Tu cuenta aceptó el guardado pero no lo conservó. Algo más lo está sobrescribiendo.", fr: "Votre compte a accepté l'enregistrement mais ne l'a pas conservé. Autre chose écrit par-dessus.", de: "Dein Konto hat die Speicherung angenommen, aber nicht behalten. Etwas anderes überschreibt sie.", ja: "アカウントは保存を受け付けましたが、保持しませんでした。他の何かが上書きしています。", zh: "你的账户接受了保存但没有保留。有别的东西在覆盖它。" },
