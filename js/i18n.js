...
(function (SYS) {
  ...
  const STRINGS = {
    ...
    "push.check": { en: "Check reminders", ar: "افحص التذكيرات", es: "Comprobar recordatorios", fr: "Vérifier les rappels", de: "Erinnerungen prüfen", ja: "リマインダーを確認", zh: "检查提醒" },
    "push.checking": { en: "Checking…", ar: "عمّال يفحص…", es: "Comprobando…", fr: "Vérification…", de: "Wird geprüft…", ja: "確認中…", zh: "检查中…" },
    "push.savedAt": { en: "Last saved to the cloud:", ar: "آخر حفظ على السيرفر:", es: "Último guardado en la nube:", fr: "Dernière sauvegarde dans le cloud :", de: "Zuletzt in der Cloud gespeichert:", ja: "クラウドへの最終保存:", zh: "上次保存到云端：" },
    "push.noDevices": { en: "The server has no device of yours. Turn reminders off and on again.", ar: "السيرفر ما عنده ولا جهاز إلك. طفّي التنبيهات وشغّلها من جديد.", es: "El servidor no tiene ningún dispositivo tuyo. Desactiva y vuelve a activar los recordatorios.", fr: "Le serveur n'a aucun de vos appareils. Désactivez puis réactivez les rappels.", de: "Der Server kennt kein Gerät von dir. Schalte Erinnerungen aus und wieder ein.", ja: "サーバーにあなたの端末がありません。リマインダーをオフにしてから再度オンにしてください。", zh: "服务器上没有你的设备。请关闭再重新开启提醒。" },
    "push.lastAttempt": { en: "Last send attempt:", ar: "آخر محاولة إرسال:", es: "Último intento de envío:", fr: "Dernier envoi tenté :", de: "Letzter Sendeversuch:", ja: "最後の送信:", zh: "上次发送尝试：" },
    "push.v.send": { en: "Sending now", ar: "بينبعث هلأ", es: "Enviándose ahora", fr: "Envoi en cours", de: "Wird jetzt gesendet", ja: "今送信中", zh: "正在发送" },
    "push.v.sent": { en: "Sent today", ar: "انبعث اليوم", es: "Enviado hoy", fr: "Envoyé aujourd'hui", de: "Heute gesendet", ja: "今日送信済み", zh: "今天已发送" },
    "push.v.later": { en: "Later today", ar: "لسا وقته ما إجا", es: "Más tarde hoy", fr: "Plus tard aujourd'hui", de: "Später heute", ja: "今日このあと", zh: "今天稍后" },
    "push.v.missed": { en: "Time passed, not sent", ar: "فات وقته وما انبعث", es: "Pasó la hora sin enviarse", fr: "Heure passée, non envoyé", de: "Zeit vorbei, nicht gesendet", ja: "時刻を過ぎたが未送信", zh: "已过时间，未发送" },
    "push.v.done": { en: "Logged today, no reminder needed", ar: "مسجّلة اليوم، ما في داعي للتذكير", es: "Registrado hoy, no hace falta", fr: "Déjà fait aujourd'hui, pas de rappel", de: "Heute erledigt, keine Erinnerung nötig", ja: "今日は記録済みのため通知なし", zh: "今天已记录，无需提醒" },
    "push.v.notDue": { en: "Not due today", ar: "مش مطلوبة اليوم", es: "No toca hoy", fr: "Pas prévu aujourd'hui", de: "Heute nicht fällig", ja: "今日は対象外", zh: "今天不需要" },
    "push.v.archived": { en: "Archived", ar: "مؤرشفة", es: "Archivado", fr: "Archivé", de: "Archiviert", ja: "アーカイブ済み", zh: "已归档" },
    "push.v.badTime": { en: "Time not readable", ar: "الوقت مش مفهوم", es: "Hora no válida", fr: "Heure illisible", de: "Uhrzeit ungültig", ja: "時刻が不正", zh: "时间无效" },
    "push.v.stale": { en: "Server has a different time", ar: "السيرفر عنده وقت غير هاد", es: "El servidor tiene otra hora", fr: "Le serveur a une autre heure", de: "Server hat eine andere Uhrzeit", ja: "サーバーの時刻が違います", zh: "服务器上的时间不同" },
    "push.v.unsynced": { en: "Not on the server yet", ar: "لسا ما وصل السيرفر", es: "Aún no está en el servidor", fr: "Pas encore sur le serveur", de: "Noch nicht auf dem Server", ja: "まだサーバーにありません", zh: "尚未同步到服务器" },
