...
(function (SYS) {
  ...
  const STRINGS = {
    ...
    "event.date": { en: "Date", ar: "التاريخ", es: "Fecha", fr: "Date", de: "Datum", ja: "日付", zh: "日期" },
    ...
    "event.badTime": { en: "The end can't be the same as the start.", ar: "لا يمكن أن يكون وقت الانتهاء نفس وقت البداية.", es: "El final no puede ser igual al inicio.", fr: "La fin ne peut pas être identique au début.", de: "Ende und Beginn dürfen nicht gleich sein.", ja: "終了を開始と同じ時刻にはできません。", zh: "结束时间不能与开始时间相同。" },
    ...
    "event.nextDay": { en: "Ends the next day", ar: "ينتهي في اليوم التالي", es: "Termina al día siguiente", fr: "Se termine le lendemain", de: "Endet am nächsten Tag", ja: "翌日に終了", zh: "次日结束" },
