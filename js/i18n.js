...
(function (SYS) {
  ...
  const STRINGS = {
    ...
    "friends.byName": { en: "Add a friend by name", ar: "أضف صديقًا بالاسم", es: "Añadir amigo por nombre", fr: "Ajouter un ami par nom", de: "Freund per Name hinzufügen", ja: "名前でフレンドを追加", zh: "按名称添加好友" },
    "friends.send": { en: "Send request", ar: "إرسال طلب", es: "Enviar solicitud", fr: "Envoyer", de: "Anfrage senden", ja: "申請する", zh: "发送请求" },
    ...
    "friends.ranking": { en: "Friends ranking", ar: "ترتيب الأصدقاء", es: "Clasificación de amigos", fr: "Classement des amis", de: "Freunde-Rangliste", ja: "フレンドランキング", zh: "好友排行" },
    ...
    "friends.none": { en: "No friends yet. Add someone by name, send an invite link, or open a profile from the ranking.", ar: "لا أصدقاء بعد. أضف أحدًا بالاسم، أو أرسل رابط دعوة، أو افتح ملفًا من الترتيب.", es: "Aún no tienes amigos. Añade a alguien por nombre, envía un enlace o abre un perfil desde la clasificación.", fr: "Pas encore d'amis. Ajoutez quelqu'un par nom, envoyez un lien ou ouvrez un profil depuis le classement.", de: "Noch keine Freunde. Füge jemanden per Name hinzu, sende einen Link oder öffne ein Profil aus der Rangliste.", ja: "まだフレンドがいません。名前で追加、招待リンクを送る、またはランキングからプロフィールを開いてください。", zh: "还没有好友。可以按名称添加、发送邀请链接，或从排行榜打开资料。" },
