...
(function (SYS) {
  ...
  const STRINGS = {
    ...
    "presetCat.faith": { en: "Faith", ar: "الإيمان", es: "Fe", fr: "Foi", de: "Glaube", ja: "信仰", zh: "信仰" },
    ...
    "preset.quran": { en: "Read Qur'an", ar: "قراءة القرآن", es: "Leer el Corán", fr: "Lire le Coran", de: "Koran lesen", ja: "クルアーンを読む", zh: "读古兰经" },
    "preset.dhikr": { en: "Morning remembrance", ar: "أذكار الصباح", es: "Recuerdo de la mañana", fr: "Invocations du matin", de: "Morgengedenken", ja: "朝の唱念", zh: "晨间记念" },
