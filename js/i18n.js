...
(function (SYS) {
  ...
  const STRINGS = {
    ...
    "form.emojiHintWin": { en: "Any emoji works — press Win + . to open your emoji keyboard.", ar: "أي إيموجي يعمل — اضغط Win + . لفتح لوحة الإيموجي.", es: "Cualquier emoji vale: pulsa Win + . para abrir el teclado de emojis.", fr: "Nimporte quel emoji convient — appuyez sur Win + . pour ouvrir le clavier demojis.", de: "Jedes Emoji geht — Win + . öffnet die Emoji-Tastatur.", ja: "どの絵文字でも使えます — Win + . で絵文字キーボードを開けます。", zh: "任何表情都可以 — 按 Win + . 打开表情键盘。" },
    "form.emojiHintMac": { en: "Any emoji works — press Control + Command + Space to open your emoji keyboard.", ar: "أي إيموجي يعمل — اضغط Control + Command + Space لفتح لوحة الإيموجي.", es: "Cualquier emoji vale: pulsa Control + Comando + Espacio para abrir el teclado de emojis.", fr: "Nimporte quel emoji convient — appuyez sur Control + Commande + Espace.", de: "Jedes Emoji geht — Control + Command + Leertaste öffnet die Emoji-Tastatur.", ja: "どの絵文字でも使えます — Control + Command + Space で絵文字キーボードを開けます。", zh: "任何表情都可以 — 按 Control + Command + 空格 打开表情键盘。" },
