...
(function (SYS) {
  ...
  const STRINGS = {
    ...
    "overview.xpOf": { en: "{exp} / 100 xp", ar: "{exp} / 100 نقطة", es: "{exp} / 100 xp", fr: "{exp} / 100 xp", de: "{exp} / 100 XP", ja: "{exp} / 100 XP", zh: "{exp} / 100 经验" },
    ...
    "overview.bankedPoints": { en: "Banked points", ar: "نقاط محفوظة", es: "Puntos guardados", fr: "Points en réserve", de: "Gesparte Punkte", ja: "保留ポイント", zh: "储备点数" },
    ...
    "intel.investHere": { en: "+1 invest here", ar: "+1 استثمر هنا", es: "+1 invertir aquí", fr: "+1 investir ici", de: "+1 hier investieren", ja: "+1 ここに投入", zh: "+1 投入此处" },
    ...
    "settings.tuning": { en: "Progression tuning", ar: "ضبط التقدم", es: "Ajuste de progresión", fr: "Réglage de la progression", de: "Fortschritts-Feinabstimmung", ja: "進行の調整", zh: "进度调节" },
    "settings.expDivisor": { en: "EXP divisor (Pt ÷ this = EXP — leave at 1 so Pt = EXP)", ar: "مُقسِّم النقاط (النقاط ÷ هذا = الخبرة — اتركه 1 ليتساويا)", es: "Divisor de XP (Pt ÷ esto = XP — déjalo en 1 para que Pt = XP)", fr: "Diviseur d'XP (Pt ÷ ceci = XP — laissez à 1 pour que Pt = XP)", de: "XP-Teiler (Pt ÷ dies = XP — bei 1 lassen, damit Pt = XP)", ja: "XP除数（Pt ÷ この値 = XP。Pt = XP にするには1のまま）", zh: "经验除数（点数 ÷ 此值 = 经验，保持为1则两者相等）" },
    "settings.pointsPerLevel": { en: "Skill points per level", ar: "نقاط المهارة لكل مستوى", es: "Puntos de habilidad por nivel", fr: "Points de compétence par niveau", de: "Fähigkeitspunkte pro Level", ja: "レベルごとのスキルポイント", zh: "每级技能点数" },
    "settings.save": { en: "Save settings", ar: "حفظ الإعدادات", es: "Guardar ajustes", fr: "Enregistrer les paramètres", de: "Einstellungen speichern", ja: "設定を保存", zh: "保存设置" },
    ...
    "admin.emailPlaceholder": { en: "user@example.com", ar: "user@example.com", es: "usuario@ejemplo.com", fr: "utilisateur@exemple.com", de: "benutzer@beispiel.com", ja: "user@example.com", zh: "user@example.com" },
    ...
    "admin.enterEmail": { en: "Enter an email.", ar: "أدخل بريدًا إلكترونيًا.", es: "Introduce un correo.", fr: "Saisissez un e-mail.", de: "Gib eine E-Mail ein.", ja: "メールアドレスを入力してください。", zh: "请输入邮箱。" },
    "admin.notFound": { en: "No account found with that email.", ar: "لا يوجد حساب بهذا البريد.", es: "No se encontró ninguna cuenta con ese correo.", fr: "Aucun compte trouvé avec cet e-mail.", de: "Kein Konto mit dieser E-Mail gefunden.", ja: "そのメールアドレスのアカウントは見つかりません。", zh: "未找到使用该邮箱的账户。" },
